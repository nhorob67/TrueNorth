...
export async function GET(request: Request) {
  ...
  try {
    ...
    for (const org of orgs ?? []) {
      try {
        ...
        await sendNotification(supabase, {
          ...
          body: "Your weekly team update has been generated. Review and share it with your team.",
        });
    ...
    console.error("Narrative weekly cron error:", err instanceof Error ? err.message : err);
