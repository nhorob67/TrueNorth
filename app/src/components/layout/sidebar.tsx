...
import { NorthStarDistance } from "@/components/north-star-distance";
...
const navigationGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { name: "Cockpit", href: "/cockpit", icon: "compass" },
      { name: "Portfolio", href: "/portfolio", icon: "grid" },
      { name: "Vision", href: "/vision", icon: "star" },
      { name: "Scoreboard", href: "/scoreboard", icon: "chart" },
    ],
  },
  {
    label: "Execution",
    items: [
      ...
      { name: "Content", href: "/content", icon: "pencil" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Sync", href: "/sync", icon: "clock" },
      { name: "Operations", href: "/ops", icon: "clipboard" },
      { name: "Processes", href: "/processes", icon: "cog" },
    ],
  },
  {
    label: "Insights",
    items: [
      ...
      { name: "Narratives", href: "/narratives", icon: "document" },
    ],
  },
  {
    label: "Meta",
    items: [
      ...
      { name: "Activity", href: "/activity", icon: "chat" },
      { name: "Todos", href: "/todos", icon: "check" },
    ],
  },
];
