...
export function CapacityBar({
  ...
  return (
    <div className={`space-y-1 ${className}`}>
      ...
      <div className="relative h-3 rounded-full bg-warm-border overflow-hidden">
        <div
          className={`h-full rounded-full transition-all ${
            isOver ? "bg-semantic-ochre" : "bg-moss"
          }`}
          style={{ width: `${betPercent}%` }}
        />
        <div
          className="absolute top-0 h-full w-0.5 bg-charcoal/40"
