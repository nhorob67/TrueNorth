...
// ── Tools ──────────────────────────────────────────────────────────
server.tool("web_search", "Search the web using Tavily Search API — returns relevant results with optional content extraction", {
...
server.tool("fetch_page_content", "Fetch and extract text content from a web page using Tavily Extract API", {
    ...
    try {
        ...
        const data = await tavilyPost("/extract", { urls: urlList });
...
server.tool("search_news", "Search for recent news articles using Tavily Search API with news topic focus", {
